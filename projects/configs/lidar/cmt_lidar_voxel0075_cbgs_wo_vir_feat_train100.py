...
train_pipeline = [
    ...
    dict(
        ...
        db_sampler=dict(
            data_root=None,
            info_path=data_root + 'nuscenes_dbinfos_train100.pkl',
            rate=1.0,
            prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=[data_root + '/nuscenes_infos_train.pkl', data_root+'/nuscenes_tail_50split_infos_train.pkl'],
            load_interval=1,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=[data_root + '/nuscenes_infos_val.pkl', data_root+'/nuscenes_tail_50split_infos_val.pkl'],
        load_interval=1,
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + '/nuscenes_infos_val100.pkl',
        load_interval=1,
        pipeline=test_pipeline,
        classes=class_names,
        modality=input_modality,
