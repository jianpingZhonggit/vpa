...
model = dict(
    ...
    train_cfg=dict(
        pts=dict(
            ...
            min_radius=2,
            grid_size=[864, 864, 40],  # [x_len, y_len, 1]
            voxel_size=voxel_size,
...
resume_from = 'work_dirs/cmt_voxel0075_vov_1600x640_cbgs_wo_vir_feat_trainval_vpa_trainval_db_xy0125/epoch_14.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 8)
