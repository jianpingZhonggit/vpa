...
train_pipeline = [
    ...
    #         data_root=None,
    #         info_path=data_root + 'nuscenes_vpa_dbinfos_train.pkl',
    #         rate=1.0,
    #         prepare=dict(
...
model = dict(
    ...
    train_cfg=dict(
        pts=dict(
            ...
            min_radius=2,
            grid_size=[2160, 2160, 80],  # [x_len, y_len, 1]
            voxel_size=voxel_size,
...
resume_from = 'work_dirs/cmt_voxel0075_vov_1600x640_cbgs_wo_vir_feat_trainval_vpa_xy005z01/epoch_15.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 8)
